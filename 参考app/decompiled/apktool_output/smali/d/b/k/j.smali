...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Ld/k/d/e;-><init>()V
...
.method public H()V
    ...
    invoke-virtual {p0}, Ld/b/k/j;->J()Ld/b/k/l;

    move-result-object v0

    invoke-virtual {v0}, Ld/b/k/l;->g()V

    return-void
.end method

.method public J()Ld/b/k/l;
    .locals 1

    iget-object v0, p0, Ld/b/k/j;->s:Ld/b/k/l;

    if-nez v0, :cond_0

    invoke-static {p0, p0}, Ld/b/k/l;->d(Landroid/app/Activity;Ld/b/k/k;)Ld/b/k/l;

    move-result-object v0

    iput-object v0, p0, Ld/b/k/j;->s:Ld/b/k/l;
...
.method public L()Ld/b/k/a;
    ...
    iget-object v0, v0, Ld/b/k/m;->l:Ld/b/k/a;
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, p1, p2}, Ld/b/k/l;->c(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public attachBaseContext(Landroid/content/Context;)V
    ...
    .line 1
    iput-boolean v1, v0, Ld/b/k/m;->M:Z

    .line 2
    iget v2, v0, Ld/b/k/m;->Q:I
    ...
    .line 3
    :goto_0
    invoke-virtual {v0, p1, v2}, Ld/b/k/m;->H(Landroid/content/Context;I)I

    move-result v2

    sget-boolean v3, Ld/b/k/m;->h0:Z
    ...
    invoke-virtual {v0, p1, v2, v4}, Ld/b/k/m;->v(Landroid/content/Context;ILandroid/content/res/Configuration;)Landroid/content/res/Configuration;
    ...
    check-cast v5, Ld/b/p/c;

    invoke-virtual {v5, v3}, Ld/b/p/c;->a(Landroid/content/res/Configuration;)V
    :try_end_1
    ...
    :cond_1c
    :goto_2
    invoke-virtual {v0, p1, v2, v6}, Ld/b/k/m;->v(Landroid/content/Context;ILandroid/content/res/Configuration;)Landroid/content/res/Configuration;

    move-result-object v0

    new-instance v2, Ld/b/p/c;

    sget v3, Ld/b/i;->Theme_AppCompat_Empty:I

    invoke-direct {v2, p1, v3}, Ld/b/p/c;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v2, v0}, Ld/b/p/c;->a(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v2}, Ld/b/p/c;->getTheme()Landroid/content/res/Resources$Theme;
    ...
    .line 17
    sget-object v3, Ld/h/e/b/i;->a:Ljava/lang/Object;

    monitor-enter v3

    :try_start_4
    sget-boolean v5, Ld/h/e/b/i;->c:Z
    :try_end_4
    ...
    sput-object v5, Ld/h/e/b/i;->b:Ljava/lang/reflect/Method;
    ...
    :goto_4
    sput-boolean v1, Ld/h/e/b/i;->c:Z

    :cond_1f
    sget-object v1, Ld/h/e/b/i;->b:Ljava/lang/reflect/Method;
    :try_end_6
    ...
    sput-object v4, Ld/h/e/b/i;->b:Ljava/lang/reflect/Method;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-super {p0, p1}, Ld/h/d/d;->dispatchKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public findViewById(I)Landroid/view/View;
    ...
    .line 1
    invoke-virtual {v0}, Ld/b/k/m;->z()V

    iget-object v0, v0, Ld/b/k/m;->i:Landroid/view/Window;
...
.method public getMenuInflater()Landroid/view/MenuInflater;
    ...
    .line 1
    iget-object v1, v0, Ld/b/k/m;->m:Landroid/view/MenuInflater;
    ...
    iget-object v2, v0, Ld/b/k/m;->l:Ld/b/k/a;
    ...
    :cond_0
    iget-object v2, v0, Ld/b/k/m;->h:Landroid/content/Context;

    :goto_0
    invoke-direct {v1, v2}, Ld/b/p/f;-><init>(Landroid/content/Context;)V

    iput-object v1, v0, Ld/b/k/m;->m:Landroid/view/MenuInflater;

    :cond_1
    iget-object v0, v0, Ld/b/k/m;->m:Landroid/view/MenuInflater;
...
.method public getResources()Landroid/content/res/Resources;
    ...
    iget-object v0, p0, Ld/b/k/j;->t:Landroid/content/res/Resources;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Ld/k/d/e;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, p0, Ld/b/k/j;->t:Landroid/content/res/Resources;
    ...
    iget-boolean v1, v0, Ld/b/k/m;->x:Z
    ...
    iget-object v1, v0, Ld/b/k/m;->l:Ld/b/k/a;
    ...
    iget-object v1, v0, Ld/b/k/m;->h:Landroid/content/Context;

    .line 4
    monitor-enter p1

    :try_start_0
    iget-object v2, p1, Ld/b/q/j;->a:Ld/b/q/n0;
    ...
    :try_start_1
    iget-object v3, v2, Ld/b/q/n0;->d:Ljava/util/WeakHashMap;
    ...
    .line 7
    invoke-virtual {v0, p1}, Ld/b/k/m;->q(Z)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Ld/b/k/l;->f()V

    invoke-virtual {v0, p1}, Ld/b/k/l;->h(Landroid/os/Bundle;)V

    invoke-super {p0, p1}, Ld/k/d/e;->onCreate(Landroid/os/Bundle;)V
...
.method public onDestroy()V
    ...
    invoke-super {p0}, Ld/k/d/e;->onDestroy()V

    invoke-virtual {p0}, Ld/b/k/j;->J()Ld/b/k/l;

    move-result-object v0

    invoke-virtual {v0}, Ld/b/k/l;->i()V
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-super {p0, p1, p2}, Ld/k/d/e;->onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    .line 1
    invoke-static {p0}, Ld/b/k/m$i;->i0(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    .line 4
    invoke-interface {p0}, Ld/h/d/f;->q()Landroid/content/Intent;
    ...
    :goto_0
    :try_start_0
    invoke-static {p0, v1}, Ld/b/k/m$i;->j0(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
    ...
    :cond_4
    :goto_1
    invoke-virtual {p0}, Ld/b/k/j;->O()V
    ...
    invoke-static {p0, p1, p2}, Ld/h/e/a;->h(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)Z

    .line 10
    :try_start_1
    invoke-static {p0}, Ld/h/d/a;->i(Landroid/app/Activity;)V
    :try_end_1
    .catch Ljava/lang/IllegalStateException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-super {p0, p1, p2}, Ld/k/d/e;->onPanelClosed(ILandroid/view/Menu;)V
...
.method public onPostCreate(Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-virtual {p1}, Ld/b/k/m;->z()V
...
.method public onPostResume()V
    ...
    invoke-super {p0}, Ld/k/d/e;->onPostResume()V
    ...
    .line 2
    invoke-virtual {v0, v1}, Ld/b/k/a;->j(Z)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1}, Ld/k/d/e;->onSaveInstanceState(Landroid/os/Bundle;)V
...
.method public onStart()V
    ...
    invoke-super {p0}, Ld/k/d/e;->onStart()V
    ...
    .line 1
    iput-boolean v1, v0, Ld/b/k/m;->O:Z
...
.method public onStop()V
    ...
    invoke-super {p0}, Ld/k/d/e;->onStop()V
...
.method public onTitleChanged(Ljava/lang/CharSequence;I)V
    ...
    invoke-virtual {p2, p1}, Ld/b/k/l;->o(Ljava/lang/CharSequence;)V
...
.method public setContentView(I)V
    ...
    invoke-virtual {v0, p1}, Ld/b/k/l;->l(I)V
...
.method public setContentView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Ld/b/k/l;->m(Landroid/view/View;)V
...
.method public setContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, p1, p2}, Ld/b/k/l;->n(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public setTheme(I)V
    ...
    .line 1
    iput p1, v0, Ld/b/k/m;->R:I

    return-void
.end method

.method public v(Ld/b/p/a;)V
    .locals 0

    return-void
.end method

.method public w(Ld/b/p/a$a;)Ld/b/p/a;
    .locals 0
