...
# instance fields
.field public final a:Ld/h/l/a;


# direct methods
.method public constructor <init>(Ld/h/l/a;)V
    .locals 0
...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Ld/h/l/a;->b(Landroid/view/View;)Ld/h/l/x/c;
    ...
    .line 1
    iget-object p1, p1, Ld/h/l/x/c;->a:Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-direct {v1, v2}, Ld/h/l/x/b;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    .line 2
    invoke-static/range {p1 .. p1}, Ld/h/l/p;->L(Landroid/view/View;)Z
    ...
    :cond_0
    invoke-virtual {v1, v5, v3}, Ld/h/l/x/b;->h(IZ)V

    .line 4
    :goto_0
    new-instance v3, Ld/h/l/o;

    sget v4, Ld/h/b;->tag_accessibility_heading:I

    const-class v7, Ljava/lang/Boolean;

    invoke-direct {v3, v4, v7, v6}, Ld/h/l/o;-><init>(ILjava/lang/Class;I)V

    .line 5
    invoke-virtual {v3, v0}, Ld/h/l/p$a;->d(Landroid/view/View;)Ljava/lang/Object;
    ...
    iget-object v7, v1, Ld/h/l/x/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual {v1, v7, v3}, Ld/h/l/x/b;->h(IZ)V

    .line 7
    :goto_2
    invoke-static/range {p1 .. p1}, Ld/h/l/p;->l(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    iget-object v6, v1, Ld/h/l/x/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    .line 9
    :goto_3
    new-instance v3, Ld/h/l/n;

    sget v6, Ld/h/b;->tag_state_description:I
    ...
    invoke-direct {v3, v6, v7, v8, v9}, Ld/h/l/n;-><init>(ILjava/lang/Class;II)V
    ...
    .line 13
    iget-object v5, v3, Ld/h/l/a$a;->a:Ld/h/l/a;

    invoke-virtual {v5, v0, v1}, Ld/h/l/a;->d(Landroid/view/View;Ld/h/l/x/b;)V
    ...
    .line 16
    sget v5, Ld/h/b;->tag_accessibility_clickable_spans:I
    ...
    .line 18
    :cond_8
    invoke-static {v2}, Ld/h/l/x/b;->d(Ljava/lang/CharSequence;)[Landroid/text/style/ClickableSpan;
    ...
    invoke-virtual {v1}, Ld/h/l/x/b;->f()Landroid/os/Bundle;

    move-result-object v10

    sget v11, Ld/h/b;->accessibility_action_clickable_span:I
    ...
    .line 19
    sget v10, Ld/h/b;->tag_accessibility_clickable_spans:I
    ...
    sget v11, Ld/h/b;->tag_accessibility_clickable_spans:I
    ...
    :cond_b
    sget v12, Ld/h/l/x/b;->d:I

    add-int/lit8 v13, v12, 0x1

    sput v13, Ld/h/l/x/b;->d:I
    ...
    .line 24
    invoke-virtual {v1, v6}, Ld/h/l/x/b;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v1, v7}, Ld/h/l/x/b;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v1, v8}, Ld/h/l/x/b;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v1, v9}, Ld/h/l/x/b;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 25
    :cond_c
    sget v2, Ld/h/b;->tag_accessibility_actions:I
    ...
    check-cast v2, Ld/h/l/x/b$a;

    invoke-virtual {v1, v2}, Ld/h/l/x/b;->a(Ld/h/l/x/b$a;)V
...
.method public onPopulateAccessibilityEvent(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-virtual {v0, p1, p2}, Ld/h/l/a;->e(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public onRequestSendAccessibilityEvent(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Ld/h/l/a;->f(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
...
.method public sendAccessibilityEvent(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Ld/h/l/a;->h(Landroid/view/View;I)V
...
.method public sendAccessibilityEventUnchecked(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-virtual {v0, p1, p2}, Ld/h/l/a;->i(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
